...
namespace SIM_Lubricentro.Controllers
{
    public class PersonalsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Nombre,Telofono,Correo,Cedula,TipoPersonal")] Personal personal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Nombre,Telofono,Correo,Cedula,TipoPersonal")] Personal personal)
        {
            if (id != personal.ID)
            {
                return NotFound();
